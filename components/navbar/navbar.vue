    ...
    <div class="flex h-screen flex-col justify-between border-e bg-white">
        <div class="px-4 py-6">
            ...
            <ul class="mt-6 space-y-1">
                <NuxtLink v-for="(item, i) in menu" :key="i" :to="item.href"
        ...
        <div class="sticky inset-x-0 bottom-0 border-t border-gray-100">
            <NuxtLink class="flex items-center gap-2 bg-white p-4 hover:bg-gray-50">
                <Avatar class=" bg-neutral-200">
                    <SVG :title="'alient'" :color="'green'"
...
let menu = [{ title: 'Жалобы', href: 'main' }, { title: 'Организации', href: 'organization' }, { title: 'О нас', href: 'about' }]
</script>