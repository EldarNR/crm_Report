<template>
    <div class="flex items-center justify-center">
        <div>
            <AlertCustome v-if="state.Error.auth.alert" :title="'Ошибка!'" :description="state.Error.auth.message"
                :svg="state.Error.auth.svg" :open="isOpen" @update:open="isOpen = $event">
            </AlertCustome>
