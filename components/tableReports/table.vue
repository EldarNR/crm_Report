<template>
    <div class="block h-16 lg:order-last lg:col-span-5 lg:h-full xl:col-span-6">
    ...
    <main
        ...
        <Table v-if="!loading">
            <TableHeader>
                <TableRow>
                    <TableHead class="text-center cursor-pointer">
                        <input type="checkbox" class="mr-2" v-model="selectAll" @click="toggleSelectAll(selectAll)" />
                    </TableHead>
            ...
            <TableBody class="mt-2 text-center mx-auto">
                ...
                <TableRow v-for="item in list" :key="item.id" @click="selectingReport(item)" class="text-center">
